...
namespace spieler
{
        ...
        : m_D3D12Resource{ d3d12Resource }
    {
        ...
        SPIELER_D3D12_ASSERT(m_D3D12Resource->GetHeapProperties(&d3d12HeapProperties, nullptr));
    ...
    {
        SPIELER_INFO("Release views of {}", GetName());
    ...
    {
        SPIELER_ASSERT(descriptor.IsValid());
    ...
    {
        SPIELER_ASSERT(m_Views.contains(descriptorType));

        const auto& descriptors = m_Views.at(descriptorType);
        SPIELER_ASSERT(index < descriptors.size());
