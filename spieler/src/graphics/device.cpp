...
namespace spieler
{
    namespace
    {
        ...
        void EnableD3D12DebugLayer()
        {
            ...
            SPIELER_D3D12_ASSERT(D3D12GetDebugInterface(IID_PPV_ARGS(&d3d12Debug)));
            d3d12Debug->EnableDebugLayer();

            ComPtr<ID3D12Debug3> d3d12Debug3;
            SPIELER_D3D12_ASSERT(d3d12Debug.As(&d3d12Debug3));
        ...
        void BreakOnD3D12Error(ID3D12Device* d3d12Device, bool isBreak)
        {
#if defined(SPIELER_DEBUG)
            {
                ...
                SPIELER_D3D12_ASSERT(d3d12Device->QueryInterface(IID_PPV_ARGS(&d3d12InfoQueue)));
        ...
        void ReportLiveD3D12Objects(ID3D12Device* d3d12Device)
        {
            ...
            SPIELER_D3D12_ASSERT(d3d12Device->QueryInterface(IID_PPV_ARGS(&d3d12DebugDevice)));
    ...
    Device::Device()
    {
        ...
        SPIELER_D3D12_ASSERT(D3D12CreateDevice(nullptr, D3D_FEATURE_LEVEL_12_0, IID_PPV_ARGS(&m_D3D12Device)));
        SetName("MainDevice");
        ...
        {
            SPIELER_ASSERT(m_DescriptorManager);
    ...
    ) const
    {
        ...
        SPIELER_D3D12_ASSERT(m_D3D12Device->CreateCommittedResource(
            &d3d12HeapProperties,
