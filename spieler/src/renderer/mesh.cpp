...
namespace spieler::renderer
{
    ...
    void MeshGeometry::SetSubmeshes(const std::unordered_map<std::string, MeshData>& submeshes)
    {
        ...
        {
            m_Submeshes[name] = spieler::renderer::SubmeshGeometry
            {
        ...
        // VertexBuffer
        {
            ...
            m_VertexBuffer.SetBufferResource(spieler::renderer::BufferResource::Create(device, config));
        }
        ...
        // IndexBuffer
        {
            ...
            m_IndexBuffer.SetBufferResource(spieler::renderer::BufferResource::Create(device, config));
        }
    }
