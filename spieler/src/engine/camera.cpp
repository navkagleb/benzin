...
namespace spieler
{
    ...
    PerspectiveProjection* FlyCameraController::GetPerspectiveProjection()
    {
        ...
        {
            SPIELER_WARNING("Projection isn't Perspective! FlyCameraController supports only PerspectiveProjection");
            return nullptr;
        }
