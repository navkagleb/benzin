...
#define SPIELER_D3D12_ASSERT(d3d12Call) SPIELER_ASSERT(SUCCEEDED(d3d12Call))

#define SPIELER_NAME_D3D12_OBJECT(d3d12Object)												\
    ...
    namespace detail
    {
        ...
        {
            SPIELER_ASSERT(d3d12Object);

            SPIELER_D3D12_ASSERT(d3d12Object->SetPrivateData(WKPDID_D3DDebugObjectName, static_cast<UINT>(name.size()), name.data()));
        }
        ...
        std::string GetD3D12ObjectName(T* d3d12Object)
        {
            ...
            SPIELER_D3D12_ASSERT(d3d12Object->GetPrivateData(WKPDID_D3DDebugObjectName, &size, name.data()));
            name.resize(size);
