namespace spieler::renderer
{
    ...
    MeshData<Index> GeometryGenerator::GenerateBox(const BoxGeometryProps& props)
    {
    ...
    template <typename Index>
    MeshData<Index> GeometryGenerator::GenerateGrid(const GridGeometryProps& props)
    {
        MeshData<Index> meshData;
    ...
    template <typename Index>
    MeshData<Index> GeometryGenerator::GenerateCylinder(const CylinderGeometryProps& props)
    {
        MeshData<Index> meshData;
    ...
    MeshData<Index> GeometryGenerator::GenerateSphere(const SphereGeometryProps& props)
    {
        ...
        {
            .Position = DirectX::XMFLOAT3{ 0.0f, props.Radius, 0.0f },
        ...
        const Vertex bottomVertex
        {
            ...
            .Normal = DirectX::XMFLOAT3{ 0.0f, -1.0f, 0.0f },
            .Tangent = DirectX::XMFLOAT3{ 1.0f, 0.0f, 0.0f },
            .TexCoord = DirectX::XMFLOAT2{ 0.0f, 1.0f },
        };
    ...
    template <typename Index>
    MeshData<Index> GeometryGenerator::GenerateGeosphere(const GeosphereGeometryProps& props)
    {
        MeshData<Index> meshData;
    ...
    template <typename Index>
    void GeometryGenerator::Subdivide(MeshData<Index>& meshData)
    {
    ...
    inline Vertex GeometryGenerator::MiddlePoint(const Vertex& lhs, const Vertex& rhs)
    {
    ...
    template <typename Index>
    void GeometryGenerator::GenerateCylinderTopCap(const CylinderGeometryProps& props, MeshData<Index>& meshData)
    {
        // Vertrices
        ...
        {
            .Position = DirectX::XMFLOAT3{ 0.0f, y, 0.0f },
            .Normal = DirectX::XMFLOAT3{ 0.0f, 1.0f, 0.0f },
            .Tangent = DirectX::XMFLOAT3{ 1.0f, 0.0f, 0.0f },
            .TexCoord = DirectX::XMFLOAT2{ 0.5f, 0.5f }
        };
    ...
    template <typename Index>
    void GeometryGenerator::GenerateCylinderBottomCap(const CylinderGeometryProps& props, MeshData<Index>& meshData)
    {
        // Vertices
        const auto baseIndex{ static_cast<uint32_t>(meshData.Vertices.size()) };
