...
namespace ImGui
{
    ...
    bool MainCollapsingHeader(std::string_view name, ImGuiTreeNodeFlags flags)
    {
    ...
    void CollapsingHeaderWithIndent(std::string_view name, const DrawCallback& callback, ImGuiTreeNodeFlags flags)
    {
