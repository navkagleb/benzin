...
namespace benzin
{
    ...
    const uint32_t GfxConfig::s_ConstantBufferAlignment = D3D12_CONSTANT_BUFFER_DATA_PLACEMENT_ALIGNMENT;
    const uint32_t GfxConfig::s_StructuredBufferAlignment = sizeof(DirectX::XMFLOAT4);
    const uint32_t GfxConfig::s_TextureAlignment = D3D12_TEXTURE_DATA_PLACEMENT_ALIGNMENT;
    const uint32_t GfxConfig::s_RayTracingShaderRecordAlignment = D3D12_RAYTRACING_SHADER_RECORD_BYTE_ALIGNMENT;
