...
namespace benzin
{
    ...
    static bool IsResourceDescriptor(DescriptorType descriptorType)
    {
        switch (descriptorType)
        {
            ...
            case DescriptorType::Dsv: return false;
        ...
        , m_IndexAllocator{ creation.MaxDescriptorCount }
    {
        ...
        d3d12DescriptorHeapDesc.Type = creation.D3D12Type;
        d3d12DescriptorHeapDesc.NumDescriptors = creation.MaxDescriptorCount;
        d3d12DescriptorHeapDesc.Flags = m_IsShaderVisible ? D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE : D3D12_DESCRIPTOR_HEAP_FLAG_NONE;
