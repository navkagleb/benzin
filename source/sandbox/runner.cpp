...
namespace sandbox
{
    ...
    Runner::Runner()
        : m_MainWindow
        {
            benzin::WindowCreation
            {
                .m_Title = "Benzin Demo",
                .m_Width = benzin::CmdLineArgs::GetWindowWidth(),
                .m_Height = benzin::CmdLineArgs::GetWindowHeight(),
            }
        }
        , m_Device{ "MainDevice", m_Backend }
        , m_SwapChain
        {
            benzin::SwapChainCreation
            {
                .m_DebugName = "MainSwapChain",
                .m_Window = m_MainWindow,
                .m_Backend = m_Backend,
                .m_Device = m_Device,
            }
        }
        , m_GpuProfiler{ m_Device }
        , m_PsoManager{ m_Device, m_ShaderManager }
        , m_RenderResources{ m_Device.GetResDependentAllocator() }
        , m_ImGuiManager{ m_MainWindow, m_FrameTimer }
        , m_RayTracingScene{ m_Scene }
        , m_CameraController{ m_Scene.m_Camera }
    {
